...
/*
   * @return - a mammal's height, as a Double
   */
  ...
  /*
   * @return - a mammal's length, as a Double
   */
  ...
  /*
   * @return - a mammal's weight, as a Double
   */
  ...
  /*
   * @return - a group that a mammal belongs to, 
   as an enum MarineMammalGroup
   */
  public MarineMammalGroup getMammalGroup() {
    return mammalGroup;
  }
  
  /*
   *Method getLargerMammal compares lengths of two 
   *marine mammals, and returns the larger mammal
   * @return - the mammal that has a larger length
   */
  public MarineMammal getLargerMammal(MarineMammal 
  					otherMammal){
    if(this.length < otherMammal.length)
      return otherMammal;
    else return new MarineMammal(this.mammalName, 
    				this.sightingDate, 
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(mammalName, that.mammalName) &&
        Objects.equals(sightingDate, that.sightingDate) &&
        Objects.equals(sightingLocation, that.sightingLocation) &&
        Objects.equals(height, that.height) &&
        Objects.equals(length, that.length) &&
        Objects.equals(weight, that.weight) &&
        mammalGroup == that.mammalGroup;
  }

  @Override
  public int hashCode() {

    return Objects.hash(mammalName, sightingDate, 
    			sightingLocation, height, 
    			length, weight, mammalGroup);
  }
}
