...
public class Account {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getName(), account.getName()) &&
                Objects.equals(getLoginEmail(), account.getLoginEmail()) &&
                Objects.equals(password, account.password);
    }

    @Override
    public int hashCode() {
        return Objects.hash(getName(), getLoginEmail(), password);
    }

    @Override
    public String toString() {
        return "Name: " + this.name + ", login: " + this.getLoginEmail().toString() + ", password: " + this.password;
    }
}
