...
public class NameTest {
    ...
    @Test
    public void equals() {
        Name other = new Name("Darth", "Vader");
        assertTrue(darthVader.equals(other));
        assertFalse(darthVader.equals("Darth Vader"));
    }

    @Test
    public void hashcode() {
        Name other = new Name("Darth", "Vader");
        assertTrue(darthVader.hashCode() == other.hashCode());
    }

    @Test
    public void tostring() {
        assertEquals("Darth Vader", darthVader.toString());
    }
}